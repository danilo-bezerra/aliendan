...
export default function Board({}: Props) {
  ...
  return (
    <div className="grid grid-cols-1">
      <header className="flex  justify-between items-center  bg-gray-800 p-4 border border-zinc-600">
      ...
      <section className="flex-1 flex gap-8 min-w-full max-w-full p-4 overflow-scroll">
        ...
        <div className="bg-zinc-700/10 w-60 rounded-md">
          <Button
            className="h-full rounded-none bg-transparent text-xl hover:bg-transparent hover:text-blue-500 "
